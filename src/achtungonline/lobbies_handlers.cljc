...
(defn handle-player-color-change
  {:test (fn []
           (is= (-> (lc/create-state :lobbies [(lc/create-lobby "0" :players [{:id "1" :color-id :pink}])] :players [{:id "1"}])
                    (handle-player-color-change {:player-id "1" :color-id :blue})
                    (lc/get-lobby "0"))
                (lc/create-lobby "0" :players [{:id "1" :color-id :blue}] :changed true))

           (is= (-> (lc/create-state :lobbies [(lc/create-lobby "0" :players [{:id "1" :color-id :pink}])] :players [{:id "1"}])
                    (handle-player-color-change {:player-id "1" :color-id :color-does-not-exist})
                    (lc/get-lobby "0"))
...
(defn handle-player-enter-lobby
  {:test (fn []
           (is= (-> (lc/create-state)
                    (handle-player-enter-lobby "0" "olle"))
